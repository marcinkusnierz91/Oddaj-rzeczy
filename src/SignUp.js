            ...
            <section className='grid-container signin'>
                ...
                <form onSubmit={this.handleSubmit} className='signin-form row'>
                        ...
                        <div className="row">
                            <div className="col-21">
                                <div className="col-4 signin-data">
                                    <input type='email' value={this.state.confirmPassword} id='confirmPassword' onChange={this.handleChange}/>
                                </div>
                            </div>
                        </div>
                        <div className="row signin-buttons">
                            <div className="col-21">
                                <div className="col-2 form-button">
                                    <input type="submit" value='Zaloguj się' className='form-submit signup-btn'/>
                                </div>
                                <div className="col-2 form-button">
                                    <Link to='/logged/'>
                                        <input type="submit" value='Załóż konto' className='form-submit signin-btn'/>
                                    </Link>
                                </div>
                            </div>
                        </div>
